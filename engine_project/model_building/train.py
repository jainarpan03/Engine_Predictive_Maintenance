...
Xtrain_path = "hf://datasets/jarpan03/engine/Xtrain.csv"
Xtest_path = "hf://datasets/jarpan03/engine/Xtest.csv"
ytrain_path = "hf://datasets/jarpan03/engine/ytrain.csv"
ytest_path = "hf://datasets/jarpan03/engine/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_engine_maintenance_model_v1.joblib"
    ...
    repo_id = "jarpan03/engine-predictive-maintenance-model"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_engine_maintenance_model_v1.joblib",
        path_in_repo="best_engine_maintenance_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
